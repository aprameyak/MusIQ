export const MusicBrainzConfig = {
  ...
  userAgent:
    process.env.MUSICBRAINZ_USER_AGENT || "MusIQ/1.0 (https://musiq.app)",
  rateLimitMs: 1000,
  ...
  albumsPerMajorGenre: parseInt(
    process.env.ETL_ALBUMS_PER_MAJOR_GENRE || "1500",
  ),
  albumsPerNicheGenre: parseInt(
    process.env.ETL_ALBUMS_PER_NICHE_GENRE || "300",
  ),
